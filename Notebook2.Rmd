...
We've chosen the following variables to be our baseline: sex, age, hhsize, & headwomen_05. As with previous examples, we note similar differences between the coefficients of our baseline values in the regression without dummy variables for cluster pair and with. The coefficients becomes less precise. The standard errors increase.
